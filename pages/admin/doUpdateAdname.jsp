...
<html lang="en">
    <head>
        ...
        <title>עדכון שם מנהל במסד נתונים | מטיילים</title>
    </head>
    <body dir="rtl">
        <!-- navbar -->
        ...
        <div>
            <form>
                <table class="layout">
                    <tr>
                        <td>
                            <label for="adName" class="label">שם מנהל</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="adName" class="field" value=<%=session.getAttribute("adName")%>>
                        </td>
                    </tr>
                    <tr>
                        <td>
