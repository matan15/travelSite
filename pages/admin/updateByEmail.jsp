...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../static/css/admin/updateByEmail.css">
            ...
            <div>
                <form action="updateByEmail.jsp" method="post">
                    <table class="layout">
                        <tr>
                            <td>
                                <label for="email" class="label">הכנס אימייל:</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="submit" class="submit-btn" value="שלח" name="send">
                            </td>
                        </tr>
                    </table>
                </form>
